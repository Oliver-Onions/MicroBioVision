...
class SingleImageAnylsisForm(QStackedWidget):
    ...
    def setupForm(self) -> QWidget:
        ...
        algorithm_picker.addItems(["Pellet Size - Microscope Images", "Coming Soon..."])
        ...
        ### This is for Pellet Size - Zeiss Microscope - currently index 1
    ...
    def _continue_button_action(self, name: str):
        ...
        if name == "Pellet Size - Microscope Images":
