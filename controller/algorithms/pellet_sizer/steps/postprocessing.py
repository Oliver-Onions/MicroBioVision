...
class PostProcessing:
    ...
    def pellet_processor(self, contour, number: int) -> list:
        ...
        diameterratio = feret_max / diameter
        ...
        Irregularity = cv2.arcLength(contour, True) / perimeter

        results = [area, diameter, perimeter, areamy, diametermy, perimetermy, volumemy, Irregularity, diameterratio]
